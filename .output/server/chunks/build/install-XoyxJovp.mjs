...
import { u as useI18n, h as useHead, p as projectInfo, i as getRuntimeEnvSync } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(steps, (s) => {
        _push(`<button type="button"${ssrIncludeBooleanAttr(isStepLocked(s.step)) ? " disabled" : ""} class="${ssrRenderClass([[
          ...
          isStepLocked(s.step) ? "opacity-40 cursor-not-allowed" : "cursor-pointer"
      ...
      if (activeStep.value === 1) {
        ...
        ssrRenderList(bucketChecks.value, (b) => {
          ...
          if (b.status === "fail" && b.detail) {
            _push(`<div class="pl-4 text-[10px] leading-snug opacity-90">${ssrInterpolate(unref(bucketFailureHint)(b))}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</li>`);
...
//# sourceMappingURL=install-XoyxJovp.mjs.map
