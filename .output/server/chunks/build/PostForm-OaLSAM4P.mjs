...
import { u as useI18n, a as useLocalePath, b as useContentLocale, d as useBranding, s as supabase } from './server.mjs';
import { MdEditor } from 'md-editor-v3';
import { RadioGroup, RadioGroupOption } from '@headlessui/vue';
import { Icon } from '@iconify/vue';
import { _ as _sfc_main$1 } from './NoImage-Df5cAWv5.mjs';
import { _ as _sfc_main$2 } from './ConfirmDialog-BMJpAaMk.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const fetchCategories = async () => {
      ...
      const { data, error } = await supabase.from("categories").select("id, name, slug, locale, translation_group_id").eq("locale", loc).order("name");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (currentMode.value === "edit" && currentPostId.value) {
        ...
        _push(ssrRenderComponent(_component_router_link, {
          to: unref(localePath)(`/posts/${slug.value}`, postLocale.value),
          target: "_blank",
      ...
      _push(ssrRenderComponent(unref(SelectRoot), {
        modelValue: categoryModel.value,
        "onUpdate:modelValue": ($event) => categoryModel.value = $event,
        disabled: fieldsLocked.value
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(SelectContent), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(SelectViewport), { class: "p-1 max-h-60" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(SelectGroup), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(ssrRenderComponent(unref(SelectItemText), { class: "truncate" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`${ssrInterpolate(unref(t)("common.uncategorized"))}`);
                                              } else {
                                                return [
                                                  createTextVNode(toDisplayString(unref(t)("common.uncategorized")), 1)
                                                ];
                                              }
                                            }),
                                            _: 1
                        ...
                        return [
                          createVNode(unref(SelectViewport), { class: "p-1 max-h-60" }, {
                            default: withCtx(() => [
                              createVNode(unref(SelectGroup), null, {
                                default: withCtx(() => [
                                  createVNode(unref(SelectItem), {
      ...
      if (!categories.value.length) {
        _push(`<div class="rounded-md border border-dashed border-gray-300 dark:border-gray-600 p-3 space-y-2"><p class="text-xs text-gray-500 dark:text-gray-400">${ssrInterpolate(unref(t)("postForm.noCategoriesYet"))}</p><div class="flex gap-2"><input${ssrRenderAttr("value", newCategoryName.value)} type="text"${ssrRenderAttr("placeholder", unref(t)("postForm.namePlaceholder"))}${ssrIncludeBooleanAttr(fieldsLocked.value || creatingCategory.value) ? " disabled" : ""} class="flex-1 h-9 rounded-md px-2 text-sm bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"><button type="button"${ssrIncludeBooleanAttr(fieldsLocked.value || creatingCategory.value || !newCategoryName.value) ? " disabled" : ""} class="inline-flex items-center gap-1 h-9 px-3 rounded-md text-sm font-medium bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300 hover:bg-green-200 dark:hover:bg-green-900/60 disabled:opacity-50">`);
        _push(ssrRenderComponent(unref(Icon), {
          icon: creatingCategory.value ? "mdi:loading" : "mdi:plus",
          class: [creatingCategory.value ? "animate-spin" : "", "text-base"]
        }, null, _parent));
        _push(` ${ssrInterpolate(unref(t)("postForm.add"))}</button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="space-y-2"><label class="text-sm font-medium flex items-center gap-2 text-gray-800 dark:text-gray-100">`);
...
//# sourceMappingURL=PostForm-OaLSAM4P.mjs.map
