...
import { _ as _sfc_main$2 } from './NoImage-Df5cAWv5.mjs';
import { a as getBrowserUrl, g as getBrowserOrigin } from './utils-BOiLVUQi.mjs';
import { b as useI18n, c as useLocalePath, _ as _export_sfc, s as supabase } from './server.mjs';
import { _ as _sfc_main$3 } from './ConfirmDialog-CDJyHT9i.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!__props.post) {
        ...
        if (__props.post.cover_image_url && !coverImageError.value) {
          _push(`<img${ssrRenderAttr("src", __props.post.cover_image_url)}${ssrRenderAttr("alt", __props.post.title + " cover image")} class="w-full h-full object-cover transition-transform duration-[1200ms] ease-[cubic-bezier(.25,.1,.25,1)] group-hover:scale-[1.04]" loading="lazy" draggable="false">`);
        } else {
          _push(ssrRenderComponent(_sfc_main$2, { plain: true }, null, _parent));
        }
...
const Comments = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8b4ed900"]]);

export { Comments as C, _sfc_main$1 as _ };
//# sourceMappingURL=Comments-ZmPmGUdU.mjs.map
