import { computed, unref, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, withModifiers, useSSRContext } from 'vue';
            ...
            _push2(ssrRenderComponent(unref(DialogPanel), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="mt-6 flex justify-end gap-3"${_scopeId2}><button type="button" class="${ssrRenderClass([
                  ...
                  _push3(`<span${_scopeId2}>${ssrInterpolate(cancelText.value)}</span></button><button type="button" class="${ssrRenderClass([
...
//# sourceMappingURL=ConfirmDialog-BMJpAaMk.mjs.map
