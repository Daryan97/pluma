<template>
  <div class="max-w-7xl mx-auto px-4 py-10">
    <div v-if="loading" class="flex flex-col items-center justify-center min-h-[60vh]">
      ...
      <p class="text-gray-700 dark:text-gray-300 text-lg">Gathering your dashboard data...</p>
    </div>
    <template v-else>
      <header class="flex items-start justify-between mb-6 flex-wrap gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2 justify-end w-full sm:w-auto">
          ...
          <CategoriesManagement class="flex-1 sm:flex-none" />
        </div>
      </header>
      ...
      <TabsRoot class="flex flex-col w-full" v-model="activeTab" default-value="overview">
        ...
        <TabsContent value="posts" class="space-y-6">
          ...
          <PostsTable
            ...
            :role="role"
            @toggleAll="toggleAll"
            @delete="(id) => askConfirmation('Delete this post?', () => deletePost(id))"
            @edit="editPost"
          >
            <template #filters>
              <PostFilters
                :selected-length="selected.length"
                @bulkDelete="askConfirmation('Delete selected posts?', bulkDelete)"
              >
                <template #status>
                        ...
                        <SelectViewport class="p-1">
                          <SelectGroup>
                            <SelectItem
                              ...
                              ><SelectItemText>All Statuses</SelectItemText></SelectItem
                            >
                            <SelectSeparator
                            ...
                            <SelectItem
                              ...
                              ><SelectItemIndicator
                                class="absolute left-0 w-8 inline-flex items-center justify-center"
                                ><Icon icon="radix-icons:check" /></SelectItemIndicator
                              ><SelectItemText>{{ s }}</SelectItemText></SelectItem
                            >
                          </SelectGroup>
                        </SelectViewport>
                          ...
                          <SelectGroup>
                            <SelectItem
                              ...
                              ><SelectItemIndicator
                                class="absolute left-0 w-8 inline-flex items-center justify-center"
                                ><Icon icon="radix-icons:check" /></SelectItemIndicator
                              ><SelectItemText>All Categories</SelectItemText></SelectItem
                            >
                            <SelectSeparator
                              class="h-px bg-gray-200 dark:bg-gray-700 my-1"
                            />
                          ...
                          <SelectGroup>
                            <SelectItem
                              ...
                              ><SelectItemIndicator
                                class="absolute left-0 w-8 inline-flex items-center justify-center"
                                ><Icon icon="radix-icons:check" /></SelectItemIndicator
                              ><SelectItemText>All Authors</SelectItemText></SelectItem
                            >
                            <SelectSeparator
                              class="h-px bg-gray-200 dark:bg-gray-700 my-1"
                            />
        ...
        >
          <PendingComments
            ...
            @delete="
              (id) =>
                askConfirmation('Delete this comment?', () => deletePendingComment(id))
            "
          />
        </TabsContent>
