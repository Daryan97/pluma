<template>
  ...
  >
    ...
    >
      <div
        class="flex items-center justify-center w-20 h-20 rounded-2xl bg-white/70 dark:bg-gray-800/60 backdrop-blur border border-gray-200 dark:border-gray-700 shadow-sm"
      >
        <Icon
          icon="mdi:image-off"
