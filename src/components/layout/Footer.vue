<template>
  ...
  >
    <!-- Base gradient -->
    <div class="absolute inset-0 z-0 bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-900 dark:to-blue-950"></div>
    <!-- Blur / tint (lighter in light mode) -->
    <div class="absolute inset-0 z-0 bg-white/40 dark:bg-gray-900/55 backdrop-blur-md supports-[backdrop-filter]:bg-white/25 supports-[backdrop-filter]:dark:bg-gray-900/45"></div>
    <!-- Decorative blobs (light mode only) -->
    <div class="pointer-events-none absolute -top-16 -right-24 w-72 h-72 rounded-full bg-blue-200/35 blur-3xl mix-blend-multiply dark:hidden"></div>
    <div class="pointer-events-none absolute -bottom-24 -left-32 w-80 h-80 rounded-full bg-indigo-200/40 blur-3xl mix-blend-multiply dark:hidden"></div>
    <div class="relative z-10 max-w-6xl mx-auto px-6 py-10">
      ...
      >
        ...
        >
          <span
            class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-500"
            >Follow</span
          >
