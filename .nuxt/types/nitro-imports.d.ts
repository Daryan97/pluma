declare global {
  const DEFAULT_SITE_DESCRIPTION: typeof import('../../src/server/utils/feeds/generator').DEFAULT_SITE_DESCRIPTION
  const DEFAULT_SITE_NAME: typeof import('../../src/server/utils/feeds/generator').DEFAULT_SITE_NAME
  const FeedGenerator: typeof import('../../src/server/utils/feeds/generator').FeedGenerator
  ...
  const createFeedGenerator: typeof import('../../src/server/utils/createFeedGenerator').createFeedGenerator
  ...
  const escapeXml: typeof import('../../src/server/utils/feeds/generator').escapeXml
  ...
  const getOriginFromRequest: typeof import('../../src/server/utils/feeds/generator').getOriginFromRequest
  ...
  const injectMeta: typeof import('../../src/server/utils/feeds/seo').injectMeta
  ...
  const parseFeedFilters: typeof import('../../src/server/utils/feeds/generator').parseFeedFilters
  ...
  const resolveSeoImage: typeof import('../../src/server/utils/feeds/seo').resolveSeoImage
  const resolveSeoPayload: typeof import('../../src/server/utils/feeds/seo').resolveSeoPayload
  const robotsForPath: typeof import('../../src/server/utils/feeds/seo').robotsForPath
  ...
  const twitterSiteFromBranding: typeof import('../../src/server/utils/feeds/seo').twitterSiteFromBranding
...
declare global {
  ...
  // @ts-ignore
  export type { FeedGenerator } from '../../src/server/utils/feeds/generator'
  import('../../src/server/utils/feeds/generator')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Projects/Web/Pluma/pluma-frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Projects/Web/Pluma/pluma-frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
