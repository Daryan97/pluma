...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../src/plugins/ensure-router-link.js")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'ensure-router-link' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin:route-locale-detect' | 'i18n:plugin' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch' | 'i18n:plugin:ssg-detect' | 'theme-sync'
  }
}
